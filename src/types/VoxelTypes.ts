...
export enum BlockType {
  ...
  // Crafting blocks (70-80)
  PRISMARINE = 70,
  PRISMARINE_BRICKS = 71,
  DARK_PRISMARINE = 72,
  WOOL_WHITE = 73,
  WOOL_BLACK = 74,
  WOOL_RED = 75,
...
export const BLOCK_TYPES: Record<BlockType, BlockData> = {
  ...
  [BlockType.PRISMARINE]: {
    ...
    hardness: 8,
    toolRequired: ToolType.PICKAXE,
    drops: [{ blockType: BlockType.PRISMARINE, quantity: 1 }],
  },
  [BlockType.PRISMARINE_BRICKS]: {
    ...
    hardness: 8,
    toolRequired: ToolType.PICKAXE,
    drops: [{ blockType: BlockType.PRISMARINE_BRICKS, quantity: 1 }],
  },
  [BlockType.DARK_PRISMARINE]: {
    ...
    hardness: 8,
    toolRequired: ToolType.PICKAXE,
    drops: [{ blockType: BlockType.DARK_PRISMARINE, quantity: 1 }],
  },
  [BlockType.WOOL_WHITE]: {
    ...
    category: BlockCategory.DECORATION,
    hardness: 0.8,
    drops: [{ blockType: BlockType.WOOL_WHITE, quantity: 1 }],
  },
  [BlockType.WOOL_BLACK]: {
    ...
    category: BlockCategory.DECORATION,
    hardness: 0.8,
    drops: [{ blockType: BlockType.WOOL_BLACK, quantity: 1 }],
  },
  [BlockType.WOOL_RED]: {
    ...
    category: BlockCategory.DECORATION,
    hardness: 0.8,
    drops: [{ blockType: BlockType.WOOL_RED, quantity: 1 }],
  },
  [BlockType.WOOL_BLUE]: {
    ...
    category: BlockCategory.DECORATION,
    hardness: 0.8,
    drops: [{ blockType: BlockType.WOOL_BLUE, quantity: 1 }],
  },
  [BlockType.WOOL_GREEN]: {
    ...
    category: BlockCategory.DECORATION,
    hardness: 0.8,
    drops: [{ blockType: BlockType.WOOL_GREEN, quantity: 1 }],
  },
  [BlockType.WOOL_YELLOW]: {
    ...
    category: BlockCategory.DECORATION,
    hardness: 0.8,
    drops: [{ blockType: BlockType.WOOL_YELLOW, quantity: 1 }],
  },
  [BlockType.BEACON]: {
    ...
    hardness: 25,
    toolRequired: ToolType.PICKAXE,
    drops: [{ blockType: BlockType.BEACON, quantity: 1 }],
  },
};
